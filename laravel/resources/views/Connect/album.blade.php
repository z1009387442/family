...
<head>
	...
	<style>
		*{margin:0; padding:0;}
		...
		.bg-box-1{
			background: url('/qiantai/o/img/1.jpg') no-repeat center/cover;
		}
		.bg-box-2{
			background: url('/qiantai/o/img/2.jpg') no-repeat center/cover;
		}
		.bg-box-3{
			background: url('/qiantai/o/img/3.jpg') no-repeat center/cover;
		}
		.bg-box-4{
			background: url('/qiantai/o/img/4.jpg') no-repeat center/cover;
		}
		#wrap{
			position: absolute;
			overflow: hidden;
