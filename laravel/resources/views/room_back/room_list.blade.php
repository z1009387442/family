                        ...
                        <div class="col-lg-12">
                            <div class="card">
                                <div class="card-header">
                                    ...
                                    <a href="{{url('admin/hotel_type/hotel_type_list')}}?id={{$hotel_id}}">酒店类型列表</a>
                                    ...
                                    <table class="table table-bordered table-striped table-condensed">
                                        ...
                                        @foreach($list as $k=>$v)
                                            <tr>
                                                ...
                                                <td>
                                                        <font color="SkyBlue">
                                                        <a href="{{url('admin/room/room_save')}}?id={{$v->room_id}}&&type_id={{$v->room_type_id}}&&hotel_id={{$v->hotel_id}}">编辑</a>　   
                                                        <a href="{{url('admin/room/room_del')}}?id={{$v->room_id}}&&type_id={{$v->room_type_id}}&&hotel_id={{$v->hotel_id}}">删除</a>
                                                        </font>
                                                </td>
                                            </tr>
                                         @endforeach
